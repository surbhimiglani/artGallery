...
public class DAOBA5 {
    ...
    private DBhelperA5 dbHelper;

    public DAOBA5(Context context) {
        dbHelper = new DBhelperA5(context);
    ...
    public long addImage(BUG image) {
        ...
        return database.insert(dbHelper.TABLE_BUG5, null, cv);
    }
    ...
    public List<BUG> getImages() {
        ...
        Cursor cursor =
                database.query(dbHelper.TABLE_BUG5, null, null, null, null,
                        null , null);
        cursor.moveToFirst();
