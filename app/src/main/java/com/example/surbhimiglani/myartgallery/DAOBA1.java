...
public class DAOBA1 {  private SQLiteDatabase database;
        private DBhelperA1 dbHelper;

        public DAOBA1(Context context) {
            dbHelper = new DBhelperA1(context);
        ...
        public long addImage(BUG image) {
            ...
            return database.insert(dbHelper.TABLE_BUG1, null, cv);
        }
        ...
        public List<BUG> getImages() {
            ...
            Cursor cursor =
                    database.query(dbHelper.TABLE_BUG1, null, null, null, null,
                            null , null);
            cursor.moveToFirst();
