...
public class A4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTexta4 = (EditText) findViewById(R.id.editText2);
        final ListView listViewa4 = (ListView) findViewById(R.id.listViewa4);
        initDB();
        dbhelp=new DBhelperA4(this);


        imadapter=new IMadapter(this,images);
        listViewa4.setAdapter(imadapter);
        ...
        listViewa4.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent display= new Intent(A4.this, Display.class);
                display.putExtra("BUGFINDER", listViewa4.getItemAtPosition(i).toString());
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_GALLERY && resultCode == RESULT_OK && data != null) {
            ...
            image.setTitle(editTexta4.getText().toString().trim());
