...
public class DAOBA4 {
    ...
    private DBhelperA4 dbHelper;

    public DAOBA4(Context context) {
        dbHelper = new DBhelperA4(context);
    ...
    public long addImage(BUG image) {
        ...
        return database.insert(dbHelper.TABLE_BUG4, null, cv);
    }
    ...
    public List<BUG> getImages() {
        ...
        Cursor cursor =
                database.query(dbHelper.TABLE_BUG4, null, null, null, null,
                        null , null);
        cursor.moveToFirst();
